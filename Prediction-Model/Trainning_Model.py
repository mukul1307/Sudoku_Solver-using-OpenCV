...
for epoch in range(epochsVal):
    print(f"Epoch {epoch + 1}/{epochsVal}")

    # Generate batches using your data generator
    dataGenIterator = dataGen.flow(X_train, y_train, batch_size=batchSizeVal)
